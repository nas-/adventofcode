...
print(
    f"Part 1: {optimize(range(min_value, max_value + 1), positions, process_positions)}"
)
print(
    f"Part 2: {optimize(range(min_value, max_value + 1), positions, process_positions_part_2)}"
)
